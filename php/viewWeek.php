...
if ($status != 2) {
    $result = mysql_query("SELECT Tasks.`index`, `course_id`, Tasks.`name` as task_name, `due_date`, `description`,Courses.`name` as course_name ,Date_format(due_date, '%H:%i') as time, difficulty "
