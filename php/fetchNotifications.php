...
for($x = 0; $x < $NUMBER_OF_DAYS; $x++) {
    ...
    $deletedTasks = mysql_query("Select msg, Courses.name as cName From Events, Courses, Users_Courses Where student_id=$user_id and Users_Courses.course_id = Courses.index and Events.course_id = Courses.index and DATEDIFF(CURDATE(), DATE(Events.created)) = $x");
